...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='群组消息关系表';
...
CREATE TABLE `user_group` (
                              ...
                              KEY `idx_group_id` (`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户群组关系表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户-消息关系表';